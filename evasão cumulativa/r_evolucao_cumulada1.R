...
# BLOCO 2 — DEFINIÇÃO DA SITUAÇÃO FINAL DO ESTUDANTE
# Critério:
...
# BLOCO 3 — INCORPORAÇÃO DA SITUAÇÃO FINAL À BASE ANALÍTICA

base_analitica <- base_analitica %>%
  left_join(
    alunos_recorte %>% select(id_aluno, situacao_final),
    by = "id_aluno"
  )

# BLOCO 4 — PADRONIZAÇÃO DO GRUPO CURRICULAR
...
# BLOCO 5 — CÁLCULO DO PERÍODO RELATIVO DE EVASÃO
...
# BLOCO 6 — FUNÇÃO PARA CÁLCULO DA EVASÃO CUMULATIVA
...
# BLOCO 7 — BASE FINAL DE EVASÃO CUMULATIVA
...
# BLOCO 8 — TABELA DE EVASÃO CUMULATIVA (DISSERTAÇÃO)
...
# BLOCO 9 — GRÁFICO: EVOLUÇÃO CUMULATIVA DA EVASÃO
